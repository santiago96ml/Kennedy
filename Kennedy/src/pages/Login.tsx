...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      navigate('/'); // Redirige al dashboard o página principal después del login
    } catch (error: any) {
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gray-900">
      ...
      <div 
        ...
        style={{
          ...
          filter: 'brightness(0.4) blur(2px)', // Oscurece y desenfoca el fondo
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-md p-8 bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20"
      >
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="block w-full pl-10 pr-3 py-2.5 border border-gray-600/50 rounded-lg bg-white/5 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="block w-full pl-10 pr-10 py-2.5 border border-gray-600/50 rounded-lg bg-white/5 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200"
                placeholder="••••••••"
              />
              <button
                type="button"
